...
from .exceptions import FatalClientError, OAuthToolError
...
class OAuthLibCore:
    ...
    def __init__(self, server=None):
        ...
        """
        validator_class = auth_settings.OAUTH2_VALIDATOR_CLASS
        validator = validator_class()
        server_kwargs = auth_settings.server_kwargs
        self.server = server or auth_settings.OAUTH2_SERVER_CLASS(validator, **server_kwargs)
    ...
    def validate_authorization_request(self, request):
        ...
        try:
            ...
            raise OAuthToolError(error=error)
    ...
    def create_authorization_response(self, request, scopes, credentials, allow):
        ...
        try:
            ...
            raise OAuthToolError(error=error, redirect_uri=credentials["redirect_uri"])
...
def get_oauthlib_core():
    ...
    validator = validator_class()
    server_kwargs = auth_settings.server_kwargs
    server = auth_settings.OAUTH2_SERVER_CLASS(validator, **server_kwargs)
    return auth_settings.OAUTH2_BACKEND_CLASS(server)
